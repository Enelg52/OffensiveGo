...
The `symtab` (symbol table) section contains information about the symbols defined in an executable file or shared library. The symtab section is generated by the Go linker (ld) during the linking phase. If a binary includes a section called symtab then it is almost guaranteed to be a GO binary.
![image](https://user-images.githubusercontent.com/75935486/233959308-05e995de-5b4b-4120-a08a-2316db818d9a.png)
